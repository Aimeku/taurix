...
async function _save() {
  ...
  if ((document.getElementById('naPlantillaSel')?.value || 'none') === 'none') { toast('Debes seleccionar una plantilla antes de guardar. Crea una desde la sección Plantillas.', 'error'); return; }
