    ...
    openModal(`
      <div class="modal">
        ...
        <div class="modal-ft">
          ...
          <button class="btn-modal-save" id="_confirmEmitir" style="background:#f97316;border-color:#ea6e00;color:#fff;font-weight:700;padding:10px 22px">📤 Sí, emitir factura</button>
        </div>
      </div>
    `);
